            ...
            child: Column(
              ...
              children: [
                  ...
                  children: [
                    Expanded(
                      child: Padding(
                        ...
                        child: Text(
                          'To the future of vertical parking!',
                    ...
                    children: [
                      ...
                      FFButtonWidget(
                        onPressed: () async {
                          ...
                          if (currentUserDocument?.car?.id == null ||
                              currentUserDocument?.car?.id == '') {
                            context.goNamedAuth('addCar', context.mounted);
                          } else {
                ...
                Padding(
                  ...
                  child: FFButtonWidget(
                    onPressed: () async {
                      context.pushNamed('parkingLotMapUnauthenticated');
                    },
                    text: 'Show map',
                    icon: Icon(
                      Icons.map,
